...
export class ContactsService {
  ...
  public static async create(record: Omit<Contacts, 'address1_addressid'>): Promise<IOperationResult<Contacts>> {
    const result = await ContactsService.client.createRecordAsync<Omit<Contacts, 'address1_addressid'>, Contacts>(
  ...
  public static async update(id: string, changedFields: Partial<Omit<Contacts, 'address1_addressid'>>): Promise<IOperationResult<Contacts>> {
    const result = await ContactsService.client.updateRecordAsync<Partial<Omit<Contacts, 'address1_addressid'>>, Contacts>(
      ContactsService.dataSourceName,
      id.toString(),
      changedFields
    );
